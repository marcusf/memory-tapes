...
var methods = function() {
  ...
  this.setRegisteredDate = function(data) {
    if (data != undefined && data.hasOwnProperty('user')) {
      localStorage['user:registered'] = data.user.registered.unixtime;
    }
  }
  
  this.getRegisteredDate = function() {
    var date = localStorage['user:registered'];
    return date === undefined ? 0 : date;
  }
